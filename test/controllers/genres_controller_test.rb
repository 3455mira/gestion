...
class GenresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create genre" do
    assert_difference('Genre.count') do
      post genres_url, params: { genre: { color_g: @genre.color_g, image_binary: @genre.image_binary, image_g: @genre.image_g, image_type: @genre.image_type } }
    end
  ...
  test "should update genre" do
    patch genre_url(@genre), params: { genre: { color_g: @genre.color_g, image_binary: @genre.image_binary, image_g: @genre.image_g, image_type: @genre.image_type } }
