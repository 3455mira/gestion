...
class IconsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create icon" do
    assert_difference('Icon.count') do
      post icons_url, params: { icon: { image_binary: @icon.image_binary, image_icon: @icon.image_icon, image_type: @icon.image_type, name_icon: @icon.name_icon } }
    end
  ...
  test "should update icon" do
    patch icon_url(@icon), params: { icon: { image_binary: @icon.image_binary, image_icon: @icon.image_icon, image_type: @icon.image_type, name_icon: @icon.name_icon } }
